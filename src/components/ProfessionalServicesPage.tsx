  ...
  const services = [
    {
      ...
      tagline: 'Delivered on time. Delivered right.',
    ...
    {
      id: '02',
      name: 'IoT Design & Architecture',
      tagline: 'Scalable by design. Integrated from the start.',
      ...
      points: [
        'IoT system architecture & blueprint design',
        'Device selection & connectivity planning',
        'Cloud & edge computing architecture',
        'Security & data privacy by design',
        'Integration design with existing infrastructure'
      ],
    ...
    },
    {
      ...
      tagline: 'Validate the idea before you invest in the build.',
      desc: 'Test and validate your IoT ideas before committing to full-scale development. By building working prototypes and conducting rigorous testing, we reduce risk and provide the evidence needed to make informed investment decisions. Our PoC services give you a solid, data-backed foundation for what comes next.',
      points: [
    ...
    {
      id: '04',
      name: 'Remote Site Survey',
      tagline: 'Deploy with confidence, not guesswork.',
      desc: 'Precise, actionable insights for IoT and network deployments — before a single device is installed. Our remote site surveys cover network coverage and signal strength analysis, identification of potential obstructions, and infrastructure optimisation recommendations. You get confidence in your deployment decisions backed by real data.',
      points: [
        'RF & network coverage mapping',
        'Signal strength & interference analysis',
        'Physical obstruction identification',
        'Device placement optimisation',
    ...
    },
    {
      ...
      tagline: 'Bespoke software built around your IoT ecosystem.',
      desc: 'Custom software development that powers your IoT solution — from web portals and mobile apps to backend platforms and API integrations. We build software tailored to your exact requirements, designed to drive operational efficiency and scale with your business as it grows.',
      points: [
    ...
    <div className={`font-sans ${theme === 'dark' ? 'bg-[#0b1118] text-white' : 'bg-white text-[#0b1118]'}`}>
          ...
          >
            ...
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 pt-10 border-t ${theme === 'dark' ? 'border-white/10' : 'border-black/10'}`}>
              <div>
                ...
                <div className={`text-[10px] font-bold uppercase tracking-widest ${theme === 'dark' ? 'text-white/40' : 'text-black/40'}`}>Service areas</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className={`text-[10px] font-bold uppercase tracking-widest ${theme === 'dark' ? 'text-white/40' : 'text-black/40'}`}>Seaford, Victoria</div>
              </div>
              <div>
      ...
      <div className="bg-[#14ACD4] py-12 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { num: '5', label: 'Core IoT service areas' },
            { num: 'PoC', label: 'Validate before you invest' },
            { num: 'End-to-end', label: 'Concept through to deployment' },
            { num: 'AU', label: 'Australian-based delivery team' }
          ].map((item, idx) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="services-list border-t border-white/10">
            {services.map((svc) => (
              <div 
                key={svc.id} 
                className={`svc-row grid grid-cols-1 md:grid-cols-2 border-b transition-all duration-500 ${
              ...
              >
                ...
                <div className="p-12 md:p-16 md:border-r border-white/10">
                  ...
                  <h3 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter mb-4 leading-none">
                    {svc.name}
                  </h3>
                  
                  <div className="text-[#14ACD4] text-[10px] font-bold uppercase tracking-[0.2em] mb-8">
                    {svc.tagline}
                  </div>
                  
                  <p className={`text-base leading-relaxed max-w-md ${theme === 'dark' ? 'text-white/50' : 'text-black/50'}`}>
                    {svc.desc}
                  </p>
                </div>
                  ...
                  <ul className="space-y-6">
                    {svc.points.map((point, pIdx) => (
                      <li key={pIdx} className="flex items-start gap-4 group">
                        ...
                        <span className={`text-sm md:text-base font-medium ${theme === 'dark' ? 'text-white/70' : 'text-black/70'}`}>
                          {point}
                        </span>
                      </li>
                    ))}
      ...
      <section className={`py-24 px-6 ${theme === 'dark' ? 'bg-[#111820]' : 'bg-gray-50'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="engage-grid grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                num: '01',
                title: 'Concept to Deployment',
                desc: 'You have an idea and need a partner to take it all the way. We scope, design, prototype, develop and deploy — handling every stage end-to-end with full project management throughout.'
              },
              {
                num: '02',
                title: 'Specific Service Engagement',
                desc: 'You already have a project underway and need specialist capability for a specific stage — a site survey before deployment, a PoC to validate a new direction, or development resource to build out a feature. We plug in where you need us.'
              },
              {
                num: '03',
                title: 'Advisory & Architecture',
                desc: 'You\'re planning a significant IoT initiative and need expert input at the architecture stage — before any development starts. We provide a full design and architecture engagement to ensure your foundations are solid before the build begins.'
              }
            ].map((item, idx) => (
              <div key={idx} className={`engage-item p-10 rounded-2xl relative overflow-hidden ${theme === 'dark' ? 'bg-[#0b1118]' : 'bg-white'}`}>
            ...
            {[
              {
                id: 'work-safety',
                type: 'Client Project',
                title: 'Australian Work Safety Company',
                desc: 'Real-time IoT platform for tracking and managing electrical equipment compliance and safety tags across construction, mining and manufacturing industries.',
                services: ['IoT Project Management', 'Web Development', 'Real-time Monitoring'],
                own: false
              },
              {
                ...
                desc: 'Design, architecture and development of Connectified\'s own wearable safety ecosystem — from initial concept through to the Samsung Galaxy Watch integration.',
                services: ['IoT Design & Architecture', 'Web & Mobile Development', 'Samsung Knox Integration'],
                own: true
              },
              {
                id: 'wireless-integration-board',
                type: 'Connectified-Built Product',
                title: 'Wireless Integration Board',
                desc: 'Custom hardware development enabling wearable safety devices to transmit alarms directly to monitoring stations and security systems via local WiFi.',
                services: ['IoT Project Management', 'Hardware Development', 'Security System Integration'],
                own: true
              },
              {
                ...
                desc: 'End-to-end integration of personal safety devices into the DirectWireless Private Network — enabling real-time alarm transmission for healthcare response.',
                services: ['IoT Design & Architecture', 'Security System Integration', 'Hardware Development'],
                own: false
              }
            ].map((proj) => (
              <button 
                key={proj.id}
                onClick={() => onNavigate('prof-cases')}
                className={`group text-left rounded-2xl overflow-hidden border transition-all duration-500 ${
            ...
            {[
              {
                ...
                desc: 'WatchArmour, Watch Guardian and the Wireless Integration Board are all Connectified-built. We don\'t just consult on IoT — we design, develop and deploy production systems ourselves.'
              },
              {
                title: 'Hardware + Software + Network',
                desc: 'Most IoT firms specialise in one layer. We span all three — hardware integration, software development, and network infrastructure. That means fewer integration problems.'
              },
              {
                title: 'Validate Before You Commit',
                desc: 'Our PoC service exists specifically to reduce the risk of large IoT investments. We test the technical and commercial feasibility of your idea before a full build begins.'
              },
              {
                title: 'Australian-Based Delivery',
                desc: 'Your project is managed from Seaford, Victoria — not handed off to an overseas delivery team. Clear communication, Australian timezone, and direct access.'
              },
              {
                title: 'Security & Compliance by Design',
                desc: 'From healthcare integration to Samsung Knox-secured wearable deployments — we build security and compliance requirements in from the architecture stage.'
              },
              {
                title: 'From PoC to Production',
                desc: 'We don\'t just deliver prototypes and walk away. Our engagement model is designed to take successful PoCs through to production deployment with the same team.'
              }
            ].map((item, idx) => (
              <div key={idx} className={`p-10 ${theme === 'dark' ? 'bg-[#111820]' : 'bg-gray-50'}`}>
